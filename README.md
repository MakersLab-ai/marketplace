...
| [**`groundcontrol-for-claude-code`**](./plugins/groundcontrol-for-claude-code) | `0.1.10` | Claude-Code-Session als autonomer Coding-Agent auf GROUNDCONTROL-Tasks — pickt Tasks, implementiert, öffnet PRs |
